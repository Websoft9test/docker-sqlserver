...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r sqlserver
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r sqlserver -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-sqlserver
cd docker-sqlserver
docker-compose  up -d
```
...
[SQL Server Administrator Guide](https://support.websoft9.com/docs/sqlserver)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [SQL Server Enterprise Support](https://apps.websoft9.com/sqlserver) 
